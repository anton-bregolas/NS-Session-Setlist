...
> [!IMPORTANT]
> The app uses some of the latest web dev features with cross-browser support. Updating to the latest version of your browser is advised for the smoothest experience.
